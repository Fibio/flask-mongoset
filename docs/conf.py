# -*- coding: utf-8 -*-
#
# Flask-MongoObject documentation build configuration file, created by
...
htmlhelp_basename = 'Flask-MongoSetdoc'
...
latex_documents = [
    ('index', 'Flask-MongoSet.tex', u'Flask-MongoSet Documentation',
     u'Fibio', 'manual'),
]
